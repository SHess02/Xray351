...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $current_year = date("Y"); 
    $role = ($graduation_year >= $current_year) ? 'student' : 'alumni';
    ...
    if (
		...
		if ($password !== $confirm_password) {
            ...
            if ($stmt->num_rows > 0) {
                ...
                $stmt = $conn->prepare("INSERT INTO user (email, role, name, graduationyear, password, securityans1, securityans2) VALUES (?, ?, ?, ?, ?, ?, ?)");
...
<body>
    ...
    <form action="register.php" method="post">
        ...
        <input type="number" name="graduation_year" min="1900" max="2099" required><br><br>
