    ...
    <div class="registration-form">
        ...
        <form>
			...
			<div class="mb-3">
                ...
                <input type="text" class="form-control" id="graduationyear" placeholder="Enter your Graduation Year" required>
            </div>
			<div class="mb-3">
                <label for="major" class="form-label">Graduation Year</label>
